...
Build Status: {<img alt="Wercker status" src="https://app.wercker.com/status/d9d99ba1334f550bd82fd6ae5218523f/s/master">}[https://app.wercker.com/akiko-pusu/redmine_banner/runs]

=== Plugin installation

==== For Redmine 2.x:

For Redmine 2.1 or later, please use Version 0.0.8 or later.
For Redmine 2.0, please use Version 0.0.7.
...
1. Banner can be used as project module.
...
* Support Redmine 2.1.
  (Redmine 2.0.x is no longer supported. Please use version 0.0.7 for Redmine 2.0.x) 
...
* Update Russian Translation.
  Thank you so much, Александр Ананьев.

=== 0.0.5

* Support banner for each project.
  Thank you so much, Denny Schäfer, Haru Iida.
...
* Add translations. Russian, German, Brazilian Portugues.
  Thank you so much, Александр Ананьев, Denny Schäfer, Maiko de Andrade!
